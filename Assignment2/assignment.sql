...
SQL> CREATE TABLE Faculty ( 
 Name VARCHAR2(100) NOT NULL, Designation VARCHAR2(50), Email VARCHAR2(100)UNIQUE, Department_ID NUMBER, CONSTRAINT fk_faculty_dept FOREIGN KEY(Department_ID) REFERENCES Department(Department_ID));
...
SQL> CREATE TABLE Course (CREATE TABLE Course ( Course_Name VARCHAR2(100) NOT NULL, Credits NUMBER, Department_ID NUMBER, Faculty_ID NUMBER, CONSTRAINT fk_Course_dept FOREIGN KEY(Department_ID) REFERENCES Department(Department_ID), CONSTRAINT fk_course_faculty FOREIGN KEY (Faculty_ID) FOREIGN KEY (Faculty_ID);
